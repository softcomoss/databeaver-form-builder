...
const FormCard = (props) => {
  ...
  useEffect(() => {
    ...
    let fetchedPermissions = JSON.parse(
      sessionStorage.getItem('__beaver__perms')
    )
      ...
      <li className='card-list-item card-deco'>
        ...
        >
          <p className='top-info'>
            Created {moment(formDetails.createdAt).fromNow()}
          </p>
          <h3
          ...
          <p className='bottom-info'>
            Modified {moment(formDetails.updatedAt).fromNow()} by{' '}
            {formDetails.createdBy.firstName} {formDetails.createdBy.lastName}
          </p>
        </a>

        {/* single form preview */}
        <div
          id={`preview${formDetails._id}`}
        ...
        <div className='border-top card-footer tx-r'>
          <div className='uk-inline '>
            ...
            <div
              ...
              className='drop-wrapper px-1h my-0'
            >
              <div className='drop-list-group'>
                <a
                  className={
                    formDetails.dispatched === true ||
                    permissions.includes('Forms_Edit_Form') === false
                      ? 'disabled'
                      : ''
                  }
                  onClick={() => {
                ...
                <a
                  ...
                  href='#'
                  onClick={() =>
                    showModal(`#generate-link-${formDetails.unique_id}`)
                  }
                >
                  Generate link
                </a>
                <a
                  href='#'
                  className={
                    permissions.includes('Forms_View_Form') ? '' : 'disabled'
                  }
                  onClick={() => {
                    setSelectedForm(formDetails)
                    showModal('#preview')
              ...
              <div className='drop-list-group'>
                ...
                <a
                  href='#'
                  className={
                    permissions.includes('Forms_Create_Form') === false
                      ? 'disabled'
                      : ''
                  }
                  onClick={() => {
              ...
              <div id={`delete-form-${formDetails._id}`} data-uk-modal>
                <div className='uk-modal-dialog uk-margin-auto-vertical border-radius'>
                  ...
                  <div className='uk-modal-body'>
                    <p>
                      You’re about to{' '}
                      <span className='co-warning'>permanently delete</span>{' '}
                      this form, are you sure you want to do that?
                    </p>
                  </div>
                  <div className='uk-modal-footer uk-text-left'>
                    <button
              ...
              <div id='edit-form' data-uk-modal>
                <div className='uk-modal-dialog uk-margin-auto-vertical border-radius'>
                  ...
                  <div className='uk-modal-body'>
                    <p>
                      You’re about to <span className='co-warning'>edit</span>{' '}
                      {formDetails.name}, are you sure you want to do that?
                    </p>
                  </div>
                  <div className='uk-modal-footer uk-text-left'>
                    <button
        ...
        <div
          id={`generate-link-${formDetails.unique_id}`}
          data-uk-modal
          className='uk-modal'
        >
          <div className='uk-modal-dialog uk-margin-auto-vertical border-radius'>
            ...
            <div className='uk-modal-body'>
              ...
              <div className='input-wrapper'>
                <label htmlFor='entries-to-collect' className='form-inputs'>
                  <input
                    onChange={(e) =>
                      addQuickExpectedNumberOfEntries(e.target.value)
                    }
                    type='number'
