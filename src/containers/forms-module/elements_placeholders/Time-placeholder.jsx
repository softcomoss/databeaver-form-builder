...
const Time = (props) => {
	...
	/**
	 * @function closemodal to be passes as props to the change element type modal
	 */
	const onCloseModal = () => {
			...
			<div
				...
				<div className="preview-container">
					...
					<div className="mb-2-nlc-noc-child formbuilder-prev-inpts overf-scroll">
						<span className="label" data-uk-tooltip={`title: ${elementDetails.label}; pos: bottom-left`}>
							{elementDetails.isMandatory && <span className="required">*</span>}
							{nameShortner(elementDetails.label, 30)}.{" "}
						</span>
						<input readOnly type="text" value="HH : MM : SS" />
					</div>
				</div>
			</div>
		</>
