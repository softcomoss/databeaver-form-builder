					...
					<div className="d-flx-alc-jsb width-100-pc px-2">
						...
						<div className="action-btn-wrapper d-flx-alc">
							...
							<div className="uk-inline">
								...
								<div data-uk-dropdown="mode: click" className="drop-wrapper px-1h uk-dropdown">
							...
							<div className="input-wrapper">
								<label htmlFor={`${elementDetails.unique_id}max`} className="form-inputs">
									<input
										...
										placeholder=" "
									/>
									<span className="label d-flx-alc">Maximum character number</span>
								</label>
							</div>
							<div className="input-wrapper">
					...
					<div className="width-100-pc d-flx prev-question">
						...
						<div className="width-100-pc formbuilder-prev-inpts">
							<label htmlFor="text" className="fb-input">
								...
								<textarea type="text" id="text" placeholder={elementDetails.placeholder} readOnly />
							</label>
						</div>
					</div>
				</div>
