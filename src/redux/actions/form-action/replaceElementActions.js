...
import { SET_ACTIVE_ELEMENT, UPDATE_ELEMENT_VIEW } from "../../action-types/form-builder-actions.types";
import uid from "uid";

export const replaceElement = (elementType, index, activePage) => (dispatch) => {
