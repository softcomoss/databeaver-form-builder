...
} from '../actions/form-action/form.actions'
import './Layout.css'
        ...
        <div className='main-wrapper main-section-wrapper no-px'>
          <div className='page-header mb-2 main-section-wrapper no-py'>
            ...
            <div className='page-navigation'>
              ...
              <a
                className='btn btn-lightgray mr-1'
                href='http://localhost:4000/forms/dispatch-form'
              >
                <svg
                  width={35}
                  height={35}
          ...
          <div className='form-builder form-builder-grid'>
            ...
            <section className='properties card-fadded-shadow-left'>
              <a
                class='my-0 capitalize microtext bg-alt p-1h uk-accordion-title'
                href='#'
              >
                properties
              </a>
